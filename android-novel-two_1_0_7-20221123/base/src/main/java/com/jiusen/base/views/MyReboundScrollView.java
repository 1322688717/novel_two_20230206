...
//        contentView.setBottom(contentView.getBottom() + DpUtil.dip2px(getContext(),65));
...
//                isMoved = false;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int offset2 = (int) (deltaY * MOVE_FACTOR);

                if (mOnOffsetChangedListener != null)
                    mOnOffsetChangedListener.onOffsetChanged(contentView, contentView.getTop());
    ...
    public interface OnOffsetChangedListener {
        void onOffsetChanged(View view, int verticalOffset);
    }
